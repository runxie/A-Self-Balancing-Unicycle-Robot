...
#define Timer TIM4
#define TimerCLK RCC_APB1Periph_TIM4


#define MotorCoderPort	GPIOD
#define RCC_APB2Periph_MotorCoderPort (RCC_APB2Periph_GPIOD | RCC_APB2Periph_AFIO)
#define MotorCoderPin	(GPIO_Pin_12 | GPIO_Pin_13)// | GPIO_Pin_14 | GPIO_Pin_15) 


u16 Counter2_Low=0;
s32 Counter2_High=0;
s32 Counter2_Temp=0;
s32 dCounter2_Temp=0;

s32 Counter2=0;
s32 dCounter2=0;


struct CoderOut2 MotorCoderData2;
...
void Counter_Getter2(void){
  //  Counter2_Low=TIM_GetCapture2(Timer);
  Counter2_Low=TIM_GetCounter(Timer);
  Counter2=Counter2_High+Counter2_Low;
  dCounter2=Counter2-Counter2_Temp;
 
  MotorCoderData2.Counter=Counter2;
  MotorCoderData2.dCounter=dCounter2;
  MotorCoderData2.ddCounter=dCounter2-dCounter2_Temp;
  
  Counter2_Temp=Counter2;
  dCounter2_Temp=dCounter2;
}
